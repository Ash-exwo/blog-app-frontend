...
const SignUp = () => {
    ...
    return (
        <div className="signup-page">
            ...
            <div className="floating-word word-one">WRITE</div>
            <div className="floating-word word-two">CREATE</div>
            <div className="floating-word word-three">SHARE</div>
                                ...
                                <div className="signup-info-content">
                                    ...
                                    <div className="feature-list">
                                        ...
                                        <div className="feature-item">
                                            ...
                                            <div>
                                                <h6>Write your way</h6>
                                                <p>Create and publish beautiful stories.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="feature-item">
                                            ...
                                            <div>
                                                ...
                                                <p>Connect with readers who love your ideas.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="feature-item">
                                            ...
                                            <div>
                                                <h6>Build your space</h6>
                                                <p>Make your voice and creativity stand out.</p>
                                            </div>
                                        </div>
